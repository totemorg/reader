...
Clone [READER file readers]REPO{reader} into your PROJECT/reader folder.   

## Requires

[ENUM standard enumerators]REPO{enum}.   
...
where [its configuration keys]SITE{shares/prm/reader/index.html}
